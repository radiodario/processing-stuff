    ...
    render: function () {
        ...
        if (authorized) {
            ...
            this.deployment_collection.fetch({
                ...
                error: function() {
                    self.logger.error('error fetching deployments', arguments);
                }
            });
...
var NavMenuView = BaseView.extend({
    ...
    highlight: function (what) {
        ...
        this.$el.find('a.jut-page-nav[href="#admin/' + what + '"]').parent().addClass('active');
    },
    ...
    _defaultNavItems: function () {
        ...
        navItems.push({
            name: 'accounts',
            title: 'Accounts',
            view: require('../accounts/account-view')
        });
        ...
        navItems.push({
            name : 'hosts',
            title : 'Hosts',
            view : require('../hosts/hosts-view')
        });

        navItems.push({
            name: 'deployments',
            title: 'Deployments',
            view: require('../deployments/deployment-view')
        });
