...
var LineChart = function() {
    ...
    var xAxis = d3.svg.axis().orient("bottom").tickSubdivide(true); // get/set?
    ...
    function chart(selection) {
        selection.each(function(rawData) {
            ...
            // update the legend if there's new data
            ...
            dispatch.on('pointMouseover.tooltip', function(e) {
                ...
                // get the bounding box around the point
                var bRect = event.toElement.getBoundingClientRect();

                // and calculate where it is
                var left = bRect.left + (bRect.right - bRect.left) * 0.5;
                var top = bRect.top;
