...
public class desertSunset extends PApplet {
...
public void draw() {/*Remains Empty*/
}
...
public void drawStar() {
  ...
  float diamStar;
  diamStar = ((height*55/100)-mouseY)*.035f;
...
public void drawCactus () {
  float diamCactus;
  diamCactus = (mouseY-(height*55/100))*.2f;
  fill(25, 45, 20);
  ...
  /*Horizontal Branch - draws "trunks" in the horizontal
   ...
   diameter. */
  float hBranchLength;
  hBranchLength = diamCactus*1.25f;
 
  for (int j=0; j<hBranchLength; j+=1) {
    ellipse(mouseX-j, mouseY-diamCactus*6, diamCactus*.8f, diamCactus*.8f);
    ellipse(mouseX+j, mouseY-diamCactus*6, diamCactus*.8f, diamCactus*.8f);
  }
  ...
  /*Vertical Branches - draws "trunks" from where the
   ...
   diameter. */
  float vBranchLength;
  vBranchLength = diamCactus*1.8f;   
 
  for (int k=0; k<vBranchLength; k+=1) {
    ellipse(mouseX-diamCactus*1.25f, (mouseY-diamCactus*6)-k, diamCactus*.8f, diamCactus*.8f);
    ellipse(mouseX+diamCactus*1.25f, (mouseY-diamCactus*6)-k, diamCactus*.8f, diamCactus*.8f);
  }
}

  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "desertSunset" };
    if (passedArgs != null) {
